...
const DEMO_STEPS = [
  ...
  },
  {
    step: "03A",
    role: "Protocol Admin",
    title: "Review protocol operations",
    why: "In manual onboarding mode, the owner-gated dashboard reviews operator applications and separates marketplace fees, treasury revenue, reserve capital, risk inputs, and optional DEX infrastructure without replacing verifier quorum.",
    href: "/admin",
    cta: "Admin overview",
  },  {
    step: "04",
  ...
  },
  {
    ...
    title: "Receive and list cycle-share tokens",
    why: "Primary funding mints transferable shares. A holder may escrow part of the position in the onchain USDC order book; a listing is not a completed trade and liquidity is not guaranteed.",
    href: "/market",
    cta: "Open market",
  },
  {
    step: "06B",
    role: "Second Investor / Buyer",
    title: "Partially fill a sell order",
    why: "The buyer may fill part or all of an active listing. Shares move to the buyer, USDC moves to the seller minus the treasury fee, and the settlement right follows the new holder.",
    href: "/market",
    cta: "Review order book",
  },  {
    step: "07",
    role: "SME Operator",
  ...
  },
  {
    ...
    why: "After distribution, current token holders redeem the settlement attached to their shares from Portfolio; sold shares are redeemed by their buyers.",
    href: "/portfolio",
    cta: "Portfolio",
  },
  {
