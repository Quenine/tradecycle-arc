...
export interface PortfolioVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allocate"
      | "allocations"
...
export interface PortfolioVault extends BaseContract {
  connect(runner?: ContractRunner | null): PortfolioVault;
  waitForDeployment(): Promise<this>;

  interface: PortfolioVaultInterface;
  ...
  allocations: TypedContractMethod<
    [arg0: BigNumberish],
    [[string, bigint] & { cycle: string; amount: bigint }],
    "view"
  >;
  ...
  totalAllocations: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "totalAllocations"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  filters: {
    "Allocated(address,uint256)": TypedContractEvent<
      AllocatedEvent.InputTuple,
      AllocatedEvent.OutputTuple,
      AllocatedEvent.OutputObject
    >;
