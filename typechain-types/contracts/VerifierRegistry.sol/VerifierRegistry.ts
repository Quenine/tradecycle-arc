...
export interface VerifierRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "activeCycleApprovalsCount",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface VerifierRegistry extends BaseContract {
  ...
  activeCycleApprovalsCount: TypedContractMethod<
  ...
  canUnstake: TypedContractMethod<[verifier: AddressLike], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "activeCycleApprovalsCount"
  ): TypedContractMethod<[verifier: AddressLike], [bigint], "view">;
  getFunction(
