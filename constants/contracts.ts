// ============================================================
//  RWYP — Contract addresses + protocol constants
...
// Both are 1% — total 2% deducted from gross profit
// Collateral (10% of capital) serves as investor protection, not the reserve fee
export const PROTOCOL_FEES = {
  defaultProtocolFee:    1,    // 1% of gross profit → treasury
  defaultReserveFee:     1,    // 1% of gross profit → reserve pool (investor protection)
  marketplaceTradingFee: 0.5,  // 0.5% per token trade → treasury
} as const
