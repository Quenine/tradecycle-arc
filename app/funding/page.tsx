...
const TEST_TODAY = [
  ...
  { label: "View Credit Passport", href: "/credit-passport/0x0000000000000000000000000000000000000000" },
] as const
        ...
        <section className="card" style={{ padding: 26, marginBottom: 16 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, marginBottom: 18 }}>
            <div>
              ...
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: 26, fontWeight: 400 }}>What judges can test today</h2>
            </div>
            <div style={{ display: "flex", gap: 10, flexShrink: 0 }}>
