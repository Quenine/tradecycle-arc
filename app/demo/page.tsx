...
const DEMO_STEPS = [
  ...
  },
  {
    ...
    role: "Investor / SME Operator / Verifier",
    title: "Get test USDC",
    why: "Test USDC lets judges fund cycles, stake as verifiers, and repay demo cycles without using real funds.",
    href: "/faucet",
    cta: "Get USDC",
  },
  {
  ...
  {
    step: "13",
    role: "Investor / SME Operator / Judge",
    ...
    href: "/credit-passport/0x0000000000000000000000000000000000000000",
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-void)" }}>
      ...
      <main style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 32px 72px" }}>
        ...
        <section className="card" style={{ padding: 22, marginBottom: 28 }}>
          <p style={{ fontSize: 13, fontWeight: 600, marginBottom: 4 }}>What judges can test today</p>
        ...
        <section className="card" style={{ padding: 26, marginBottom: 16 }}>
          <p style={{ fontSize: 11, fontFamily: "var(--font-mono)", color: "var(--gold)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 10 }}>Winning submission path</p>
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: 26, fontWeight: 400, marginBottom: 14 }}>Why this demonstrates stablecoin commerce</h2>
